...
import paymentMethodIcons from "../../assets/JoChaho Assets/Feature Icons/paymentmethods.png";
import facebook from "../../assets/JoChaho Assets/social-icons/Facebook.svg";
import twitter from "../../assets/JoChaho Assets/social-icons/Twitter.svg";
import youtube from "../../assets/JoChaho Assets/social-icons/YouTube.svg";
import github from "../../assets/JoChaho Assets/social-icons/Github.svg";
import instagram from "../../assets/JoChaho Assets/social-icons/Instagram.svg";

import appleStore from "../../assets/JoChaho Assets/social-icons/appleStore.svg";
import googleStore from "../../assets/JoChaho Assets/social-icons/googleStore.svg";
import varifiedImg from "../../assets/JoChaho Assets/Feature Icons/varified.png";
          ...
          <div className="container-xl">
            <div className="footer-top-row">
                ...
                <div>
                  ...
                  <div className="footer-contact-info">
                    ...
                    <div className="contact-info">
                      ...
                      <p
                        className="k-row1 call-btn"
                        style={{ color: footer ? footer?.text_color : null }}
                      >
                        {footer ? footer.phone_number : null}
                      </p>
                    </div>
                  </div>
                  <h3 className="footer-sec-heading">Verified By</h3>
                  <img src={varifiedImg} alt="varifiedCertificate" />
                </div>
              ...
              <div className="footer-top-col">
                <h3 className="footer-sec-heading">Payment Methods</h3>
                <img src={paymentMethodIcons} alt="Payment Method" />

                <h3 className="footer-sec-heading">Follow Us</h3>
                ...
                <h3 className="footer-sec-heading">App Coming Soon!</h3>
                <img src={appleStore} alt="Social Icons" />
                <img src={googleStore} alt="Social Icons" />
              </div>
            </div>
          </div>
        </div>
